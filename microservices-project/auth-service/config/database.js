...
// // Fetch the database URL from the .env file or hard-code it if needed
// const sequelize = new Sequelize(process.env.AUTH_DB_URL, {
//   dialect: 'postgres', // Change to the correct database dialect
...
// module.exports = sequelize; // Export for use in models and elsewhere
